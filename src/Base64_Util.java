...
public class Base64_Util {
     ...
     * @retutn:  路径
     * */
    public static String createSimpleRelativePath(String dirName) {
        String dir = format.format(date).substring(0, 8);
        stringBuffer.append("./").append(dirName).append("/").append(dir).append("/").append(getNewImageNameByDate()).append(".jpg");
